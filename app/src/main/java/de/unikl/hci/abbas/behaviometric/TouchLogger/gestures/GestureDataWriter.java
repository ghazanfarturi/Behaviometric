...
public class GestureDataWriter {
     ...
     */
    public GestureDataWriter(Context c) throws IOException {
     ...
     * @param filename Name of the destination file. Will be placed under /sdcard/Behaviometric/
     */
    public void writeCompressedLoggerData(final LinkedList<GestureLoggerData> data, final String filename) {
        Runnable r = new Runnable() {
            @Override
            public void run() {
                try {
                    ...
                    for(GestureLoggerData gld : data) {
